...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const svgString = await constructView(await interaction.options.getInteger('month'));
 ...
 * @returns {String}
 */
async function constructView (month) {
...
<g transform="translate(10, 69.5)">`;
    ...
    //add last row
    const finalSvg = await attachLastRow(firstWeekday, lastDayOfMonth, middleRow[0], middleRow[1], middleRow[2]);
