...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => subcommand.setName('add').setDescription('add a new entry')
            ...
            .addStringOption(option => option.setName('title').setDescription('title').setMaxLength(256).setRequired(true))
            ...
            .addStringOption(option => option.setName('tags').setDescription('tags').setMaxLength(2048))
