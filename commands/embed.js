...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand => subcommand.setName('create').setDescription('create a new embed')
            .addStringOption(option => option.setName('description').setDescription('embed text').setMaxLength(2000).setRequired(true))
            .addStringOption(option => option.setName('title').setDescription('embed title'))
            .addStringOption(option => option.setName('color').setDescription('hex'))
            ...
            .addStringOption(option => option.setName('name').setDescription('save as'))
        ...
        .addSubcommand(subcommand => subcommand.setName('edit').setDescription('edit a saved embed')
            .addStringOption(option => option.setName('name').setDescription('embed name').setRequired(true))
            .addStringOption(option => option.setName('description').setDescription('embed text').setMaxLength(2000))
            .addStringOption(option => option.setName('title').setDescription('embed title'))
            .addStringOption(option => option.setName('color').setDescription('hex'))
            .addStringOption(option => option.setName('image').setDescription('image url'))
            .addStringOption(option => option.setName('author').setDescription('author name'))
